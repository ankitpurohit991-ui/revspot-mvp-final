...
import { X, History, Plus, ArrowRight } from "lucide-react";
    ...
    >
      {open && (
        <>
          ...
          <div ref={scrollRef} className="flex-1 overflow-y-auto px-3.5 pt-3.5 pb-1 scroll">
            {thread.length === 0 ? (
          ...
          {/* Composer */}
          <div className="px-3.5 pb-3.5 pt-2 border-t border-border-subtle">
            <SpotComposer
              value={draft}
              onChange={setDraft}
              onSend={() => send()}

...
export const campaignsList: CampaignListItem[] = [
  {
    id: "camp-1",
    name: "Prestige Lakeside Habitat — Lead Gen",
    type: "Performance",
  ...
  {
    id: "camp-7",
    name: "Assetz Mizumi PM R3 — Lead Gen",
    type: "Performance",
  ...
  {
    id: "camp-8",
    name: "Purva Atmosphere — Brand Awareness",
    type: "Brand",
    client: "Puravankara",
    status: "active",
    spend: 75000,
  ...
  {
    id: "camp-10",
    name: "Prestige City — Retargeting",
    type: "Performance",
    client: "Prestige Group",
    status: "paused",
    spend: 48000,
